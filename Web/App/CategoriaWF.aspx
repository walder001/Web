<%@ Page Title="" Language="C#" MasterPageFile="~/App/Site1.Master" AutoEventWireup="true" CodeBehind="CategoriaWF.aspx.cs" Inherits="Web.App.CategoriaWF" %>
    ...
    <section>
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-face zmdi-hc-fw"></i> Categoria <small>datos</small></h1>
			</div>
		</div>
		<div class="container-fluid">
			<div class="row">
									    ...
									    <form action="" runat="server">
									    	...
									    	<div class="form-group label-floating">
											  <asp:Label ID="Label1" runat="server" class="control-label" Text="ProveedorId"></asp:Label>
											   <asp:TextBox ID="CategoriaId" runat="server" class="form-control"  ></asp:TextBox>
											</div>
