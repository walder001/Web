...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Deafult.aspx.cs" Inherits="Web.App.Default" %>
...
<body class="cover" style="background-image: url(./assets/img/loginFont.jpg);">
	<form action="Inicio.aspx" autocomplete="off" class="full-box logInForm">
